...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // All const functions (initTrackBindings, setupOcrCropTool, runYoloDetect, etc.)
  // are defined below — calls are deferred to end of DOMContentLoaded block
  ...
  // ── Deferred calls (all const functions now defined above) ──
  setupOcrCropTool();
  initTrackBindings();
});
